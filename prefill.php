...
$fields = [
    'author_name' =>            ['Your name',             'Twaambo Haamucenje',                                                ''],
    'author_github_username' => ['Your Github username',  'twoSeats',       ''],
    'author_email' =>           ['Your email address',    'twaambo@outlook.com',                                                ''],
    'author_twitter' =>         ['Your twitter username', 'twoSeats',                                                '@{author_github_username}'],
    'author_website' =>         ['Your website',          '',                                                'https://github.com/{author_github_username}'],

    'package_vendor' =>         ['Package vendor',        'twaambo',   '{author_github_username}'],
    'package_name' =>           ['Package name',          'silhouette',  ''],
    'package_description' =>    ['Package very short description',   '',                                     ''],

    'psr4_namespace' =>         ['PSR-4 namespace',       'usually, Twaambo\\Silhouette',                        '{package_vendor}\\{package_name}'],
];
